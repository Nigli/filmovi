...
<?php
    foreach (Listafilmova::GetAllFromMovies() as $k=>$movie){
    ?>
    <div class="row">
        ...
        <div class="imdb_rating">
            <a class="tooltip" title="Open IMDB for <?php echo $movie->name?>" href="http://www.imdb.com/title/<?php echo $movie->imdb_id?>/" target="_blank"><span class="imdbRatingPlugin" data-user="ur49068862" data-title="<?php echo $movie->imdb_id?>" data-style="p4"></span></a>
        </div>
    </div>
<?php
}
