...
<form class="movie_insert" action="<?php echo "movie_insert.php"; ?>" method="post">
...
<?php 
    ...
    <form class="row_admin" action="movie_delete.php" method="post">
            <input class="imdb_admin" type="text" readonly="" name="imdb_id" value="<?php echo $res['imdb_id']?>" />
            <input class="movie_name_admin" type="text" readonly="" name="movie_name" value="<?php echo $res['name']?>" />
<!--                <input class="submit_admin" type="submit" name="edit" value="izmeni" />-->
            <input class="delete_admin" type="submit" name ="delete" onClick="return confirm('Obrisati film <?php echo $res['name']?>?');" value="obriši" />
    </form>        
<?php
}    
?>
